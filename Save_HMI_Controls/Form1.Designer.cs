namespace Save_HMI_Controls
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            lyhMenuItem7.TargetPageName = "";
            lyhMenuItem7.Text = "基础反馈";
            lyhMenuItem2.SubItems.Add(lyhMenuItem3);
            lyhMenuItem2.SubItems.Add(lyhMenuItem7);
            ...
            lyhMenuItem9.TargetPageName = "About";
            lyhMenuItem9.Text = "关于授权";
            treeMenu1.Items.Add(lyhMenuItem1);
            treeMenu1.Items.Add(lyhMenuItem2);
            treeMenu1.Items.Add(lyhMenuItem8);
