namespace Save_HMI_Controls
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            lyhMenuItem11.TargetPageName = "InputText";
            lyhMenuItem11.Text = "文本输入框";
            lyhMenuItem8.SubItems.Add(lyhMenuItem9);
            lyhMenuItem8.SubItems.Add(lyhMenuItem10);
            lyhMenuItem8.SubItems.Add(lyhMenuItem11);
            ...
            lyhMenuItem13.TargetPageName = "About";
            lyhMenuItem13.Text = "关于授权";
            treeMenu1.Items.Add(lyhMenuItem1);
            treeMenu1.Items.Add(lyhMenuItem2);
            treeMenu1.Items.Add(lyhMenuItem12);
            treeMenu1.Items.Add(lyhMenuItem13);
